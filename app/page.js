  ...
  return (
    <div>
      ...
      <div className="rs-smoother-yes">
        ...
        <header>
          <div className="rs-header-area rs-header-one" id="header-sticky">
              ...
              <div className="rs-header-inner">
                ...
                <div className="rs-header-right">
                  <div className="rs-header-search-wrapper">
                    <div className="rs-header-search-icon">
                      <i className="ri-close-fill has-close"></i>
                      <i className="ri-search-line has-search"></i>
                    </div>
                    <form className="rs-header-search-inner rs-stickys-form" action="#">
                  ...
                  <div className="rs-header-btn">
                    <a className="rs-btn has-theme-orange has-icon has-bg" href="#">Get In Touch
        ...
        <div className="fix">
          <div className="offcanvas-area" data-lenis-prevent>
            <div className="offcanvas-wrapper">
              <div className="offcanvas-content">
                <div className="offcanvas-top d-flex justify-content-between align-items-center mb-20">
                  <div className="offcanvas-logo">
                    <a className="logo-black" href="index.html"><img src="assets/images/top-logo.svg" alt="logo" /></a>
                  </div>
                ...
                <div className="offcanvas-contact mb-30">
                  ...
                  <ul>
                    ...
                    <li className="d-flex align-items-center gap-15">
                      ...
                      <div className="offcanvas-contact-text">
                        <a href="tel:+12346691234"> +91 8242434677 </a>
                      </div>
                    </li>
                    <li className="d-flex align-items-center gap-15">
                      <div className="offcanvas-contact-icon">
                      ...
                      <div className="offcanvas-contact-text">
                        <a href="mailto:india@delightintl.ae">india@delightintl.ae</a>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-xl-2">
                  <div className="rs-banner-meta-wrapper">
                    <div className="rs-banner-contact-item">
                      <span>Email.</span>
                      <h6><a href="mailto:ndia@delightintl.ae ">ndia@delightintl.ae </a></h6>
                    </div>
                    <div className="rs-banner-contact-item">
                      <span>Call.</span>
                              ...
                              <div className="rs-banner-content">
                                ...
                                <div className="rs-banner-info-btn">
                                  <div className="rs-banner-btn">
                                    <a className="rs-btn has-theme-orange has-icon has-bg" href="contact.html">Explore More
                                      <span className="icon-box">
                                  ...
                                  <div className="rs-feature-video">
                                    <a href="https://www.youtube.com/watch?v=Yue48fUXuqI" className="rs-play-btn popup-video"><i className="ri-play-fill"></i></a>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div className="rs-feature-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                    <div className="rs-feature-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="62" viewBox="0 0 60 62" fill="none">
                        ...
                        <path d="M39.985 47C39.9806 46.9998 39.9761 46.9998 39.9717 46.9998C38.8834 46.9998 37.8622 47.4225 37.0948 48.1905C36.3242 48.9617 35.9023 49.9885 35.9068 51.0818C35.9112 52.1727 36.3399 53.1992 37.1138 53.9724C37.8877 54.7456 38.9145 55.1733 40.0053 55.1767H40.0187C41.1069 55.1767 42.1283 54.7541 42.8957 53.9861C43.6662 53.2149 44.0881 52.1881 44.0837 51.0948C44.0792 50.004 43.6506 48.9775 42.8768 48.2043C42.1027 47.4311 41.0758 47.0035 39.985 47ZM41.6199 52.7117C41.1915 53.1405 40.6196 53.3803 40.0108 53.3737C39.3992 53.3717 38.8229 53.1313 38.3881 52.6969C37.9532 52.2624 37.7123 51.6862 37.7097 51.0746C37.7072 50.4654 37.9419 49.8938 38.3703 49.4649C38.7986 49.0361 39.3728 48.799 39.9792 48.8029C40.5908 48.805 41.1672 49.0453 41.6021 49.4798C42.037 49.9142 42.2779 50.4904 42.2803 51.102C42.2829 51.7113 42.0483 52.2828 41.6199 52.7117Z" fill="#1e70b6"></path>
                        <path d="M11.6896 10.377C12.4465 10.377 12.8624 9.37328 12.3272 8.838L9.25306 5.76337C8.42893 4.93899 7.15378 6.21402 7.97804 7.03815L11.0521 10.1129C11.2282 10.289 11.459 10.377 11.6896 10.377Z" fill="#1e70b6"></path>
                        <path d="M5.2216 24.5806H0.874229C-0.29141 24.5806 -0.29141 26.3837 0.874229 26.3837H5.22172C6.38736 26.3837 6.38736 24.5806 5.2216 24.5806Z" fill="#1e70b6"></path>
                        <path d="M11.327 40.7375L8.25294 43.8121C7.42869 44.6364 8.70383 45.9114 9.52797 45.0869L12.602 42.0123C13.4263 41.188 12.1511 39.9131 11.327 40.7375Z" fill="#1e70b6"></path>
                      </svg>
                    </div>
                    <h5 className="rs-feature-title">
                      Industrial Ideas
                    </h5>
            ...
            <div className="container">
                  ...
                  <div className="rs-section-title-wrapper">
                    <span className="rs-section-subtitle has-theme-orange justify-content-start">
                      <svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
                        <path d="M3.14286 10L0 15L8.78104e-07 0L3.14286 5V10Z" fill="#1e70b6"></path>
                ...
                <div className="col-xl-5 col-lg-5">
                  <div className="rs-about-content">
                    <div className="rs-about-description">
                      <p className="descrip-1">Welcome to Industrie, a leading industry innovator with a rich history of
                        excellence.</p>
                      <p className="descrip-2">At the heart of the global landscape, the industry stands as a
                        multidimensional force of
                        progress, driving economies. </p>
                    </div>
                    <div className="rs-about-btn">
                      <a className="rs-btn has-theme-orange has-icon has-bg" href="about.html">Discover More
                        <span className="icon-box">
                          <svg className="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                            <path
                              d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="rs-about-thumb wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                    <div className="rs-about-bg-thumb" data-background="assets/images/about/about-thumb-01.png"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        /
            ...
            <div className="container">
              <div className="row  g-5 section-title-space align-items-center">
                <div className="col-xl-7 col-lg-7">
                  <div className="rs-section-title-wrapper">
                    ...
                    <h2 className="rs-section-title rs-split-text-enable split-in-fade">Creative features from production industry</h2>
                  </div>
                </div>
                <div className="col-xl-5 col-lg-5">
                  <div className="rs-services-btn">
                    <a className="rs-btn has-bg-transparent has-icon has-bg" href="services.html">View All Solution
                      <span className="icon-box">
                        <svg className="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                          <path
                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
              ...
              <div className="row g-5">
                    ...
                    <ul className="nav nav-pills" id="pills-tab" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="pills-item-one-tab" data-bs-toggle="pill" data-bs-target="#pills-item-one" type="button" role="tab" aria-controls="pills-item-one" aria-selected="true">
                          Industrial Construction <span className="rs-services-icon"><svg
                      ...
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="pills-item-two-tab" data-bs-toggle="pill" data-bs-target="#pills-item-two" type="button" role="tab" aria-controls="pills-item-two" aria-selected="false"> High regulation industry <span className="rs-services-icon"><svg
                          xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12"
                          fill="none">
                          <path fillRule="evenodd" clipRule="evenodd"
                            d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                      ...
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="pills-item-three-tab" data-bs-toggle="pill" data-bs-target="#pills-item-three" type="button" role="tab" aria-controls="pills-item-three" aria-selected="false">
                          Bridge Construction<span className="rs-services-icon"><svg xmlns="http://www.w3.org/2000/svg"
                      ...
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="pills-item-four-tab" data-bs-toggle="pill" data-bs-target="#pills-item-four" type="button" role="tab" aria-controls="pills-item-four" aria-selected="false">
                          Oil &amp; Gas Energy<span className="rs-services-icon"><svg xmlns="http://www.w3.org/2000/svg"
                            width="18" height="12" viewBox="0 0 18 12" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd"
                              d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                              fill="white"></path>
                      ...
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="pills-item-five-tab" data-bs-toggle="pill" data-bs-target="#pills-item-five" type="button" role="tab" aria-controls="pills-item-five" aria-selected="false">
                          Mechanical Engineering<span className="rs-services-icon"><svg
                            xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12"
                            fill="none">
                            <path fillRule="evenodd" clipRule="evenodd"
                              d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                      ...
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="pills-item-six-tab" data-bs-toggle="pill" data-bs-target="#pills-item-six" type="button" role="tab" aria-controls="pills-item-six" aria-selected="false">
                          Automation Industry<span className="rs-services-icon"><svg xmlns="http://www.w3.org/2000/svg"
                            width="18" height="12" viewBox="0 0 18 12" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd"
                              d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                              fill="white"></path>
                ...
                <div className="col-xxl-9 col-xl-8 col-lg-8">
                  <div className="rs-services-tab-wrapper">
                    <div className="tab-content rs-services-tab-anim" id="pills-tabContent">
                      <div className="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabIndex="0">
                        <div className="rs-services-tab-content-wrapper p-relative">
                          <div className="row g-5 align-items-center">
                            ...
                            <div className="col-xl-6 col-lg-6">
                              <div className="rs-services-tab-content">
                                <h3 className="rs-services-tab-title">We solve
                                ...
                                <div className="rs-services-tab-list">
                                  <ul>
                                ...
                                <div className="rs-services-tab-btn">
                                  <a className="rs-btn has-text has-icon" href="services-details.html">Read More
                                    <span className="icon-box">
                                      <svg className="icon-first" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 32 32">
                                        <path
                      ...
                      <div className="tab-pane fade" id="pills-item-two" role="tabpanel" aria-labelledby="pills-item-two-tab" tabIndex="0">
                        <div className="rs-services-tab-content-wrapper p-relative">
                          <div className="row g-5 align-items-center">
                            ...
                            <div className="col-xl-6 col-lg-6">
                              <div className="rs-services-tab-content">
                                <h3 className="rs-services-tab-title">A high regulation industry refers </h3>
                                <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                  printer took a galley. </p>
                                <div className="rs-services-tab-list">
                                  <ul>
                      ...
                      <div className="tab-pane fade" id="pills-item-three" role="tabpanel" aria-labelledby="pills-item-three-tab" tabIndex="0">
                        <div className="rs-services-tab-content-wrapper p-relative">
                          <div className="row g-5 align-items-center">
                            ...
                            <div className="col-xl-6 col-lg-6">
                              <div className="rs-services-tab-content">
                                <h3 className="rs-services-tab-title">Bridge construction is a complex engineering
                                </h3>
                                <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                  printer took a galley. </p>
                                <div className="rs-services-tab-list">
                      ...
                      <div className="tab-pane fade" id="pills-item-four" role="tabpanel" aria-labelledby="pills-item-four-tab" tabIndex="0">
                        <div className="rs-services-tab-content-wrapper p-relative">
                          <div className="row g-5 align-items-center">
                            ...
                            <div className="col-xl-6 col-lg-6">
                              <div className="rs-services-tab-content">
                                <h3 className="rs-services-tab-title">The oil and gas energy sector is a crucial
                                </h3>
                                <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                  printer took a galley. </p>
                                <div className="rs-services-tab-list">
                      ...
                      <div className="tab-pane fade" id="pills-item-five" role="tabpanel" aria-labelledby="pills-item-five-tab" tabIndex="0">
                        <div className="rs-services-tab-content-wrapper p-relative">
                          <div className="row g-5 align-items-center">
                            ...
                            <div className="col-xl-6 col-lg-6">
                              <div className="rs-services-tab-content">
                                <h3 className="rs-services-tab-title">Mechanical engineering is a broad field</h3>
                                <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                  printer took a galley. </p>
                                <div className="rs-services-tab-list">
                                  <ul>
                      ...
                      <div className="tab-pane fade" id="pills-item-six" role="tabpanel" aria-labelledby="pills-item-six-tab" tabIndex="0">
                        <div className="rs-services-tab-content-wrapper p-relative">
                          <div className="row g-5 align-items-center">
                            ...
                            <div className="col-xl-6 col-lg-6">
                              <div className="rs-services-tab-content">
                                <h3 className="rs-services-tab-title">The automation industry involves the
                                  application</h3>
                                <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                  printer took a galley. </p>
                                <div className="rs-services-tab-list">
          ...
          <section className="rs-work-step-area rs-work-step-one section-space-bottom primary-bg">
            <div className="container">
              <div className="row">
                <div className="col-xl-12">
                  <h2 className="rs-work-step-section-title">Work Process</h2>
                </div>
              </div>
              <div className="rs-work-step-wrapper">
                <div className="row g-5 process-counts">
                  <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="rs-work-step-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                      <h5 className="rs-work-step-title">Analysis of the client's objectives & needs</h5>
                      ...
                      <div className="rs-work-step-descrip">
                        <p> Our approach to project management is grounded in practical experience and prioritises
                          open
                          communication. </p>
                      </div>
                    </div>
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="rs-work-step-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                      ...
                      <div className="rs-work-step-descrip">
                        <p> We collaborate closely on with you and examine the strategy and install and integrate the
                          mechanical. </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="row  g-5 section-title-space align-items-end">
                <div className="col-xxl-7 col-xl-8 col-lg-8">
                  <div className="rs-section-title-wrapper">
                    ...
                    <h2 className="rs-section-title">Explore Large-Scale Projects</h2>
                  </div>
                </div>
                <div className="col-xxl-5 col-xl-4 col-lg-4">
                  ...
                  <div className=" rs-portfolio-navigation">
                    ...
                    <button className="swiper-button-next rs-swiper-btn has-bg-light"><i
                        ...
                        <div className="swiper-slide">
                          <div className="rs-portfolio-item">
                            ...
                            <div className="rs-portfolio-content">
                              ...
                              <h4 className="rs-portfolio-title underline has-white"><a href="portfolio-details.html">Metal
                                Industry</a></h4>
                              <div className="rs-portfolio-btn">
                                <a href="portfolio-details.html" className="rs-btn has-theme-orange has-circle has-icon">
                                  <span className="icon-box">
                                    <svg className="icon-first" xmlns="http://www.w3.org/2000/svg"
                                      viewBox="0 0 32 32">
                                      <path
                        ...
                        <div className="swiper-slide">
                          <div className="rs-portfolio-item">
                            ...
                            <div className="rs-portfolio-content">
                              ...
                              <h4 className="rs-portfolio-title underline has-white"><a href="portfolio-details.html">Manufacture</a></h4>
                              <div className="rs-portfolio-btn">
                                <a href="portfolio-details.html" className="rs-btn has-theme-orange has-circle has-icon">
                                  <span className="icon-box">
                                    <svg className="icon-first" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="swiper-slide">
                          <div className="rs-portfolio-item">
                            ...
                            <div className="rs-portfolio-content">
                              ...
                              <h4 className="rs-portfolio-title underline has-white"><a href="portfolio-details.html">Oil &amp;
                                Gas Factory</a></h4>
                              <div className="rs-portfolio-btn">
                                <a href="portfolio-details.html" className="rs-btn has-theme-orange has-circle has-icon">
                                  <span className="icon-box">
          ...
          <div className="rs-cta-area rs-cta-one ">
            <div className="container">
              <div className="rs-cta-wrapper">
                <div className="rs-cta-bg" data-background="assets/images/bg/cta-bg-01.png"></div>
                <div className="row">
                  <div className="col-xl-12">
                    <div className="rs-cta-item-wrapper">
                      <div className="rs-cta-item  wow fadeIn" data-wow-delay=".3s">
                        <div className="rs-cta-inner">
                          <div className="rs-cta-number-wrapper">
                            <span className="rs-cta-number odometer" data-count="3,050">00</span>
                          </div>
                          <span className="rs-cta-title">Success Projects</span>
                        </div>
                      </div>
                      <div className="rs-cta-item  wow fadeIn" data-wow-delay=".5s">
                        <div className="rs-cta-descrip">
                          <p>There are many variations of passages lorem ipsum available, but the majority have
                            suffered alteration in some form. </p>
                        </div>
                      </div>
                      <div className="rs-cta-item  wow fadeIn" data-wow-delay=".7s">
                        <div className="rs-cta-btn">
                          <a className="rs-btn has-theme-orange has-icon has-white has-bg" href="contact.html">Consultation
                            &amp; Quote
                            <span className="icon-box">
                              <svg className="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                <path
              ...
              <div className="row  g-5 justify-content-center section-title-space align-items-center">
                <div className="col-xxl-7 col-xl-8 col-lg-8">
                  <div className="rs-section-title-wrapper text-center">
                    ...
                    <h2 className="rs-section-title rs-split-text-enable split-in-fade">The Best Industry Experts</h2>
                  </div>
                </div>
              </div>
              <div className="row g-5">
                  ...
                  <div className="rs-team-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                    ...
                    <div className="rs-team-content-wrapper">
                      <div className="rs-team-content-box">
                        <h5 className="rs-team-title"><a href="team-details.html">Peter Hase</a></h5>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="rs-team-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                    ...
                    <div className="rs-team-content-wrapper">
                      <div className="rs-team-content-box">
                        <h5 className="rs-team-title"><a href="team-details.html">Jack Peter</a></h5>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="rs-team-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                    ...
                    <div className="rs-team-content-wrapper">
                      <div className="rs-team-content-box">
                        <h5 className="rs-team-title"><a href="team-details.html">Bradley Roy</a></h5>
                        <span className="rs-team-designation">Sr. Engineer</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="row  g-5 section-title-space align-items-center">
                <div className="col-xl-7 col-lg-7">
                  <div className="rs-section-title-wrapper">
                    ...
                    <h2 className="rs-section-title rs-split-text-enable split-in-fade">What people say about Industrie company</h2>
                  </div>
                </div>
                <div className="col-xl-5 col-lg-5">
                  <div className="rs-testimonial-btn">
                    <a className="rs-btn has-theme-orange has-icon has-bg" href="contact.html">More Reviews
                      <span className="icon-box">
                        <svg className="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                          <path
                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
              ...
              <div className="row">
                <div className="col-12">
                  <div className="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false" data-delay="2500" data-item="3" data-item-xl="3" data-item-lg="3" data-item-md="2" data-item-sm="1" data-item-xs="1" data-item-mobile="1" data-margin="30" data-margin-xl="30">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="rs-testimonial-item has-clip-path">
                            ...
                            <div className="rs-testimonial-top">
                              <div className="rs-testimonial-avater-wrapper">
                                ...
                                <div className="rs-testimonial-avater-info">
                                  ...
                                  <span className="rs-testimonial-avater-designation">Ceo</span>
                                </div>
                              </div>
                            ...
                            <div className="rs-testimonial-top">
                              <div className="rs-testimonial-avater-wrapper">
                                ...
                                <div className="rs-testimonial-avater-info">
                                  ...
                                  <span className="rs-testimonial-avater-designation">Team Manager</span>
                                </div>
                              </div>
                              <div className="rs-testimonial-icon">
                                <img src="assets/images/brand/brand-thumb-01.png" alt="image"/>
              ...
              <div className="row  g-5 section-title-space justify-content-center">
                <div className="col-xl-7 col-lg-7">
                  <div className="rs-section-title-wrapper text-center">
                    ...
                    <h2 className="rs-section-title rs-split-text-enable split-in-fade">Partners Who Trust Industrie
                    </h2>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-xl-12">
                  <div className="rs-brand-wrapper">
                    <div className="swiper" data-clone-slides="false" data-loop="true" data-speed="1500" data-autoplay="false" data-dots-dynamic="false" data-center-mode="false" data-hover-pause="true" data-effect="false" data-delay="1500" data-item="6" data-item-xl="4" data-item-lg="4" data-item-md="3" data-item-sm="2" data-item-xs="2" data-item-mobile="1">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
      ...
      /
          <section className="rs-blog-area section-space rs-blog-one">
            <div className="container">
              <div className="row  g-5 section-title-space align-items-center">
                <div className="col-xl-7 col-lg-7">
                  <div className="rs-section-title-wrapper">
                    ...
                    <h2 className="rs-section-title rs-split-text-enable split-in-fade">Articles & blog posts with useful information</h2>
                  </div>
                </div>
                <div className="col-xl-5 col-lg-5">
                  <div className="rs-blog-btn">
                    <a className="rs-btn has-theme-orange has-icon has-bg" href="blog.html">View All Post
                      <span className="icon-box">
                        <svg className="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                          <path
                            d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
              ...
              <div className="row g-5">
                <div className="col-xl-6 col-lg-6">
                  <div className="rs-blog-item has-thumb-height wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                    <div className="has-bg has-clip-path rs-blog-bg-thumb" data-background="assets/images/blog/blog-thumb-01.png">
                    </div>
                    <div className="rs-blog-content has-position">
                      ...
                      <h3 className="rs-blog-title has-white has-big underline"> <a href="blog-details.html">Construction
                        of a new high tech plant in
                        washingtons</a></h3>
                      <p className="rs-blog-description has-white">Industry's standard dummy text ever since the 1500s,
                    ...
                    <div className="col-12">
                      <div className="rs-blog-item has-grid">
                        <div className="rs-blog-content has-padding order-1 order-sm-0">
                          ...
                          <h5 className="rs-blog-title underline has-black"> <a href="blog-details.html">Building
                            resilient supply
                            chains for</a></h5>
                    ...
                    <div className="col-12">
                      <div className="rs-blog-item has-grid">
                        <div className="rs-blog-content has-padding order-1 order-sm-0">
                          ...
                          <h5 className="rs-blog-title underline has-black"> <a href="blog-details.html">Factories
                            technologies in
          ...
          <section className="rs-contact-area rs-contact-one section-space black-bg p-relative">
            <div className="rs-contact-bg" data-background="assets/images/bg/contact-bg-01.png">
            </div>
            <div className="container">
              <div className="row align-items-xl-center g-5">
                <div className="col-xl-7 col-lg-7">
                  <div className="rs-contact-wrapper">
                    <div className="rs-section-title-wrapper">
                      ...
                      <h2 className="rs-section-title mb-30 rs-split-text-enable split-in-fade">Have a project in mind?
                        Contact with us</h2>
                      <p className="descrip">There are many variations of passages of Lorem Ipsum available, but the
                        majority have suffered alteration in some form by injected humour.</p>
                    </div>

                    <div className="rs-contact-list">
                      <div className="rs-contact-list-item  wow fadeIn" data-wow-delay=".3s">
                      ...
                      <div className="rs-contact-list-item  wow fadeIn" data-wow-delay=".5s">
                        <div className="rs-contact-icon">
                          <span>
                        ...
                        <div className="rs-contact-list-content">
                          ...
                          <h6 className="mb-5"><a href="tel:971551579261">+971 551 579 261</a></h6>
                          <h6><a href="tel:971551579261">+97 155 596 1659</a></h6>
                        </div>
                      </div>
                      <div className="rs-contact-list-item  wow fadeIn" data-wow-delay=".7s">
                        <div className="rs-contact-icon">
                          <span>
                        ...
                        <div className="rs-contact-list-content">
                          ...
                          <h6><a href="mailto:india@delightintl.ae">india@delightintl.ae</a></h6>
                        </div>
                      </div>
                      <div className="rs-contact-list-item  wow fadeIn" data-wow-delay=".7s">
                        <div className="rs-contact-icon">
                        ...
                        <div className="rs-contact-list-content">
                          ...
                          <p className=""> Mon - Fri: 09am - 07pm</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-xl-5 col-lg-5">
                  <div className="rs-contact-form wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s">
                    <div className="rs-contact-form-bg-thumb" data-background="assets/images/bg/contact-bg-03.png"></div>
                    <h3 className="rs-contact-form-title">Get in Touch</h3>
                    <p className="descrip">The point of using Lorem Ipsum is that it has more-or-less normal</p>
                      ...
                      <div className="row g-4">
                        ...
                        <div className="col-md-12">
                          <div className="rs-contact-btn">
                            <button type="submit" className="rs-btn black-bg">Send Message</button>
                          </div>
                        </div>
                      </div>
                    </form>
